...
public class Fraction
{
    ...
    {
        Console.WriteLine("In explicit conversioin to int");
        return theFraction.numberator / theFraction.denominator;
    }
    ...
    public static Fraction operator+(Fraction lhs, Fraction rhs)
    {
        ...
        int firstProdct = lhs.numerator * rhs.denominator;
        int secondProduct = rhs.numerator * lhs.denominator;
        return new Fraction(firstProdct + secondProduct, lhs.denominator * rhs.denominator);
    }
